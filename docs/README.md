...
When visiting `/api-docs`, you may see a React strict mode warning about `UNSAFE_componentWillReceiveProps` in the browser console. This is a known issue with the `swagger-ui-react` library (v5.29.4) and does not affect functionality. The warning is automatically suppressed in our implementation.

**Status:** Waiting for upstream fix in swagger-ui-react  
**Impact:** None - API documentation works perfectly  
